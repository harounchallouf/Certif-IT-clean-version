                ...
                return (
                    <div style={{ position: 'relative' }} id="template1" >
                        ...
                        <div className="info" style={{ position: 'absolute', top: '39%', left: '36%', width: '60%' }}>
                            <h2 style={{ textTransform: 'uppercase', color: '#0e4573', textDecoration: 'underline', marginBottom: '1rem' }}>{this.props.heading === '' ? 'CERTIFICAT DE RÉUSSITE' : this.props.heading}</h2>
                            <h3 style={{ fontSize: '16px', fontWeight: '500', color: '#ff9800', textTransform: 'uppercase', letterSpacing: '3px' }}>Décerné à</h3>
                            <h1 style={{ fontSize: '3rem', color: '#33d5ac' }}>{this.props.name === '' ? 'Name' : this.props.name}</h1>
                            <p style={{ fontSize: '15px', fontWeight: '600', color: '#ff9800' }}>{this.props.desc === '' ? 'pour avoir passé avec succés son examen.' : this.props.desc}</p>
                        </div>
...
DIRECTEUR DE CERTIFICAT</h2>
                            <h1 style={{ fontSize: '20px', color: '#ff9800', textTransform: 'uppercase' }}>{this.props.author === '' ? 'Author Name' : this.props.author}</h1>
                        </div>
                        <img src={logo} style={{ position: 'absolute', width: '9rem', borderRadius: '50%', top: '20%', left: '35%' }} alt="logo" />

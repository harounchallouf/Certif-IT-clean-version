...
function EditQuiz(props) {
	...
	const submitCSV = async (questions) => {
		setLoading(true);
		let token = props.loggedUser.token;		let url = "http://localhost:3000/question/csv";

		let captcha = null; // await executeRecaptcha("submit_csv");
	...
	const handleRestart = async () => {
		let token = props.loggedUser.token;		let url = `http://localhost:3000/quiz/restart`;

		let captcha = null; // await executeRecaptcha("restart_quiz");
	...
	const handleQuizClose = async () => {
		let token = props.loggedUser.token;		let url = `http://localhost:3000/quiz/close`;

		let captcha = null; // await executeRecaptcha("quiz_close");
	...
	const handleDeleteQuestion = async () => {
		let token = props.loggedUser.token;		let url = `http://localhost:3000/question/${updateId}`;
	...
	const handleDelete = async () => {
		let token = props.loggedUser.token;		let url = `http://localhost:3000/quiz/delete`;
	...
	const handleQuestionUpdate = async () => {
		...
		let token = props.loggedUser.token;		let url = `http://localhost:3000/question/update/${updateId}`;

		let captcha = null; // await executeRecaptcha("question_update");
	...
	const handleQuestionSubmit = async () => {
		...
		let token = props.loggedUser.token;		let url = `http://localhost:3000/question/add`;

		let captcha = null; // await executeRecaptcha("submit_question");
	...
	const isOwnerOfQuiz = async () => {
		let token = props.loggedUser.token;		let url = `http://localhost:3000/quiz/checkAdmin/${quizId}`;
	...
	const getQuizDetails = async () => {
		setLoading(true);
		console.log("aposdkoapsdpasodk", props)
		let token = props.loggedUser.token;		let url = `http://localhost:3000/quiz/${quizId}`;
		...
		url = `http://localhost:3000/question/all/${quizId}`;
		...
		url = `http://localhost:3000/admin/allStudentsQuizResult/${quizId}`;
	...
	useEffect(() => {
		let token = props.loggedUser.token;		// if (token === null) {
		// 	setLoading(false);
		// 	setRedirect(true);
		// 	return;
		// }

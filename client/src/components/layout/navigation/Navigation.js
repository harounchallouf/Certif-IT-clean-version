                        ...
                        <Nav className="ml-auto">
                            ...
                            </Link>
                            {
                                this.props.loggedUser
                                    ?
                                    <>
                                        <Nav.Link as="div" className="border-top mouse-hover" onClick={this.logOut}>Log out</Nav.Link>
                                    ...
                                    :
                                    <>
                                        <Nav.Link as="div" onClick={() => this.handleModal(true)} className="border-top mouse-hover ">Log in</Nav.Link>
